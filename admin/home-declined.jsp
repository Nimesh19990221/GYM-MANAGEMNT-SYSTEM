                                        ...
                                        <div class="sc_table">
                                            <table>
                                                <tr class="customtable">
                                                    ...
                                                    <th><a href="home-accepted.jsp">Accepted Reservations</a></th>
                                                    <th class="activepage"><a href="home-declined.jsp">Declined Reservations</a></th>
                                                </tr>
                                                        ...
                                                        <div class="sc_section bg_tint_none">
                                                            <div class="sc_content content_wrap">
                                                                <div class="sc_section bg_tint_none aligncenter">
                                                                    <h2 class="sc_title style_3">Declined Reservations</h2>
                                                                </div>
                                                                ...
                                                                ResultSet rs = null;
                                                                String sql = "select * from reservations where `status`='declined'";
                                                            ...
                                                            %>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <form method="post" action="../ApproveReservation">
