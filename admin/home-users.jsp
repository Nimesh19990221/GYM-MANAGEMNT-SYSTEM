...
<html lang="en-US">
    <%
        ...
        if (session.getAttribute("username") == null) {
            ...
            usrid = session.getAttribute("uid").toString();
        }
    ...
    <body class="single single-courses layout_single-courses body_style_fullscreen page-template-courses article_style_boxed top_panel_style_dark top_panel_opacity_solid top_panel_above menu_right sidebar_hide">
                ...
                <div class="modal-content">
                    <form method="post" action="../newuser">
                        ...
                        <div class="modal-body">
                            ...
                            <select name="utype" class="form-control" id="sel1">
                                <option name="utype" value="member">Member</option>
                                <option name="utype" value="trainer">Trainer</option>
                                <option name="utype" value="manager">Manager</option>
                            </select>
                            <div class="form-group">
        ...
        <div class="body_wrap">
                                        ...
                                        <div class="sc_section bg_tint_none">
                                            <div class="sc_content content_wrap">
                                                <div class="sc_section bg_tint_none aligncenter">
                                                    <h2 class="sc_title style_3">Users</h2>
                                                </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form method="post" action="../removeUser">
                                                                        <input type="hidden" name="req_id" value="<%= rs2.getString(1)%>">
            ...
            <div data-toggle="modal" data-target="#RegModal" class="float my-float">
